<div class="py-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {{-- herro --}}
    <section class="group">
        <div class="relative overflow-hidden rounded-2xl bg-gray-900 mb-12 h-96 col-span-6">
        ...
        <div class="absolute inset-0 flex flex-col items-start justify-center px-6 sm:px-12 lg:px-16">
            ...
            @if($posts->isNotEmpty())
                <a href="{{ route('news.show', $posts->first()->slug) }}" wire:navigate
                ...
                @forelse($posts as $post)
                    <article wire:key="post-{{ $post->id }}"
                        ...
                        @if ($post->featured_image)
                            <a href="{{ route('news.show', $post->slug) }}" wire:navigate>
